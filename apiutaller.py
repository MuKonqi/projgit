...
appname="Projgit" # Don't forget to change this! This is necessary for Apiutaller.
appfolder="/usr/bin/" # Don't forget to change this! This is necessary for Apiutaller.
appfileold="projgit.py" # Don't forget to change this! This is necessary for Apiutaller.
appfilenew="projgit" # Don't forget to change this! This is necessary for Apiutaller.
policyfile=any # Options: policy file and any
appdesktopfile="projgit.desktop" # Options: desktop file and any
mainappfolder="/usr/local/bin/" # Options: Your way for your main app folder or any
mainappfoldername="projgit" # Options your main app folder for icon, modules etc. or any
...
arch_pacman_dependencies="git python3 tk" # Options: "dependencies" and any
opensuse_zypper_support="true" # Options: true and false
opensuse_zypper_dependencies="git python python-tk" # Options: "dependencies" and any
rhel_yum_support="true" # Options: true and false
rhel_yum_dependencies="git python3 python3-tkinter" # Options: "dependencies" and any
